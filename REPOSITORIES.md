...
## Pushing server changes

```bash
cd SkillAra_server
git remote -v   # should point to Mohankumar-21/SkillAra_server
git add .
...
```bash
git remote set-url origin https://github.com/Mohankumar-21/SkillAra_server.git
```
